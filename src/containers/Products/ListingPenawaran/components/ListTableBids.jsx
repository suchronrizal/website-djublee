  ...
  render() {
    ...
    listDetail.map(val =>
      data.push({
        ...
        price: formatCurrency(val.bid_price || 0)
      })
    );
    return (
      <div>
...
ListTableBids.propTypes = {
  listBidByType: PropTypes.func.isRequired,
